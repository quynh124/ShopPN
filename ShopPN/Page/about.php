   ...
   ?>
    ...
    <div class="box-banner-about-2">
        <div class="in-box-banner">
            <img src="../Picture/Shop/banner-33.jpg" alt="">
        </div>
    </div>
    <div class="box-introduce-1">
        <div class="box-picture">
            <img src="../Picture/Shop/banner-34.jpg" alt="">
        </div>
        <div class="box-content-1">
            <div class="in-first-title">WE DESIGN PN</div>
            <h2 class="in-second-title">Simple Creative</h2>
            <div class="all-box-boder-in">
                <div class="box-boder-in"></div>
            </div>
            <div class="in-container">
            At PN, we believe that a beautiful living space can transform emotions and elevate your lifestyle.
We are a team of experts specializing in interior design and construction, dedicated to delivering creative, sophisticated, and personalized solutions for every client's unique style.

With years of experience, we take pride in creating flawless interior spaces — from apartments and townhouses to luxury villas and modern offices.
We pay close attention to every detail, carefully selecting high-quality materials and blending functionality with aesthetics to craft comfortable, cozy, and inspiring living environments.

Your satisfaction is our greatest success.
Let PN accompany you on the journey to turn your dream home into reality!
            </div>
            <div class="in-container">
    ...
    <div class="box-introduce-1">
        <div class="box-content-1">
            ...
            <h2 class="in-second-title">Design Quaility</h2>
            <div class="all-box-boder-in">
                <div class="box-boder-in"></div>
            </div>
            <div class="in-container">
            We prioritize excellence in design. Our work blends elegance and functionality, creating spaces that are not only beautiful but also highly practical.
Every detail is thoughtfully crafted, ensuring a perfect balance between aesthetic appeal and lasting quality.
At PN, exceptional design isn’t just a goal — it’s our commitment to every project we undertake.
            </div>
            <div class="in-container">
