...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['btn_login'])) {
    $email = trim($_POST['getemail']);
    $password = trim($_POST['getpass']);

    if ($email === 'admin@gmail.com' && $password === 'admin789') {
        $_SESSION['user_email'] = $email; // Lưu email vào session
        $_SESSION['is_admin'] = true;    // Đánh dấu người dùng là admin
    ...
    <div>
        <div class="all-container">
            <div class="box-picture">
                <div class="box-text" style="padding-left: 1200px;">
                <div class="card">
                    ...
                    <form class="form" method="POST" action="login.php">
                        ...
                        <input spellcheck="false" class="input" type="email" id="email" name="getemail" />
                        ...
                        <input spellcheck="false" class="input" type="text" id="password" name="getpass" />
                     
                        <button type="submit" name="btn_login" class="submit" >Submit</button>
