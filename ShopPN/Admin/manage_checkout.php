...
require './_dbcon.php'; // Đảm bảo tệp này chứa kết nối cơ sở dữ liệu


$query_checkout = mysqli_query($connect, "SELECT total_price, status, order_date,name,email, address, payment_method, created_at , final_price, discount_amount FROM orders ORDER BY order_id DESC");
...
<?php
$sql_checkout="SELECT * from orders ORDER BY order_id DESC";
$query_checkout= mysqli_query($mysqli,$sql_checkout);
 ?>
        ...
        <div class="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Manage Order</h3>
                            <button class="Btn" style="margin-bottom: 20px; margin-top: 20px;">
                                <a href="checkout/add.php" style="color: white;">Add Order</a></button>
                            ...
                            <div class="table-responsive">
                                <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                    ...
                                    <?php 
                $i = 0;
                while ($row = mysqli_fetch_array($query_checkout)) {
                    $i++;
                ?>
               <tr>
                    ...
                    <td>
                    <a href="checkout/edit.php?order_id=<?php echo $row['order_id']; ?>" class="Btn">Edit</a>
                    </td>
                    <td>
                        <a href="./checkout/data_processing.php?orderid=<?php echo $row['order_id']; ?>" class="Btn">Delete</a>
                        </td>
