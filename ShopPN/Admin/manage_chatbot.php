...
$query_chatbot = mysqli_query($connect, "SELECT queries,replies FROM chatbot");
...
<?php
$sql_chatbot="SELECT * from chatbot ORDER BY id DESC";
$query_chatbot= mysqli_query($mysqli,$sql_chatbot);
 ?>
<!DOCTYPE html>
<html lang="en">
                            ...
                            <li>
                                <div class="message-center">
                                    <a href="javascript:void(0);">
                                        <div class="user-img">
                                            <img src="../plugins/images/users/logo.jpg" alt="user" class="img-circle">
        ...
        <div class="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                    <div class="white-box">
    <h3 class="box-title m-b-0">Manage ChatBot</h3>
    <button class="Btn" style="margin-bottom: 20px; margin-top: 20px;">
        <a href="chatbot/add.php" style="color: white;">Add Chatbot</a></button>
    ...
    <div class="table-responsive">
        <table id="example23" class="display nowrap" cellspacing="0" width="100%">
            ...
            <tbody>
                <?php 
                $i = 0;
                while ($row = mysqli_fetch_array($query_chatbot)) {
                    $i++;
                ?>
                 <tr>
                    ...
                    <td>
                    <a href="chatbot/edit.php?id=<?php echo $row['id']; ?>" class="Btn">Edit</a>
                    </td><td>
                    <a href="./chatbot/data_processing.php?id=<?php echo $row['id']; ?>" class="Btn">Delete</a>
                </td>
                <?php } ?>
            </tbody>
        </table>
