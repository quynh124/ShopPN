...
$query_review = mysqli_query($connect, "SELECT email, rating, comment FROM reviews");
...
<?php
$sql_review="SELECT * from reviews ORDER BY review_id DESC";
        ...
        <div class="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Manage Feedback</h3>
                            <!-- <button type="button" class="Btn" style="float: right; margin-bottom: 10px;">
                                <a href="review/add.php" style="color: white;">Add Feedback</a></button> -->
                            ...
                            <div class="table-responsive">
                                <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <?php 
                $i = 0;
                while ($row = mysqli_fetch_array($query_review)) {
                    $i++;
                ?>
               <tr>
                    ...
                    <td>
                    <a href="review/edit.php?reviewid=<?php echo $row['review_id']; ?>" class="Btn">Edit</a>
                    </td>
                    <td>
                        <a href="./review/data_processing.php?reviewid=<?php echo $row['review_id']; ?>" class="Btn">Delete</a>
                        </td>
                </tr>
                <?php } ?>
                                        </tr>
