...
$query_category = mysqli_query($connect, "SELECT category_name, created_at FROM categories");
...
<?php
$sql_category="SELECT * from categories ORDER BY category_id DESC";
        ...
        <div class="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Manage Category</h3>
                            <button class="Btn" style="margin-bottom: 20px; margin-top: 20px;">
                                <a href="category/add.php" style="color: white;">Add Category</a></button>
               ...
               <tr>
                    ...
                    <td>
                    <a href="./category/edit.php?categoryid=<?php echo $row['category_id']; ?>" class="Btn">Edit</a>
                    </td><td>
                        <a href="./category/data_processing.php?categoryid=<?php echo $row['category_id']; ?>" class="Btn">Delete</a>
                </td>
                <?php } ?>
            </tbody>
                                </table>
