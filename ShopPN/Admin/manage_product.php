...
$query_product = mysqli_query($connect, "SELECT category_id, name, description, price, stock, image, created_at FROM products WHERE category_id = 1"); // Thay thế 1 bằng id của
...
<?php
$sql_product="SELECT * from products ORDER BY product_id DESC";
        ...
        <div class="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                    <div class="white-box">
    <h3 class="box-title m-b-0">Manage Product</h3>
    <button class="Btn" style="margin-bottom: 20px; margin-top: 20px;">
        <a href="product/add.php" style="color: white;">Add Product</a></button>    <p class="text-muted m-b-30">Export data to Copy, CSV, Excel, PDF & Print</p>
        ...
        <table id="example23" class="display nowrap" cellspacing="0" width="100%">
            ...
            <tbody>
               ...
               <tr>
                    ...
                    <td><img src="../Page/image/<?php echo $row['image'] ?>" width="50px"></td>
                    <td><?php echo htmlspecialchars($row['created_at']); ?></td>
                    <td>
                    <a href="./product/edit.php?product_id=<?php echo $row['product_id']; ?>" class="Btn">Edit</a>
                    </td>
                    <td>
                        <a href="./product/data_processing.php?product_id=<?php echo $row['product_id']; ?>" class="Btn">Delete</a>
                    </td>
                </tr>
                <?php } ?>
            </tbody>
